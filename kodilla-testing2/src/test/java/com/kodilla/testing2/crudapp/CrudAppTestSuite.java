...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://greedfire.github.io/";
             ...
             driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(theForm -> {
                    WebElement deleteButton = driver.findElement(By.xpath(".//div/fieldset[1]/button[4]"));
                    deleteButton.click();
                });
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("GreedFire");
        driverTrello.findElement(By.id("password")).sendKeys("Hstokn132");
